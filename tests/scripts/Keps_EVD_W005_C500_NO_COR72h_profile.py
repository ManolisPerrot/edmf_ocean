...
saving_path = '../figures/'
saving_name = 'Keps_EVD_'+case+'72h_profile_LES_vs_EDMF.png'
...
run_label = ['NEMO TKE+EVD', 'Croco k-epsilon', 'EDMF-Energy']
runs = [
    {
        'eddy_diff': True,
