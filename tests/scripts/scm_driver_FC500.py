...
case        = 'FC500'
saving_path = '../figures/'
saving_name = case+'72h_profile_FC500.png'
###########################################
end_time   = 72
#===========================================================================
compar_les = 1
if compar_les==1:
  les_dir    = "/mnt/c/Users/flori/OneDrive/Bureau/Codes/edmf_JAMES_2024/zenodo_edmf_energy/data/FC500/"
...
common_params = {
    ...
    'wp_a': 1.,
    'wp_b': 1.,      # 'wp_b': 1.
    'wp_bp': 0.0035*350,   #*300,     #      0.002,
    'up_c': 0.25,
    'vp_c': 0.25,
    'bc_ap': 0.2,    #0.3,
    'delta_bkg': 0.5*0.0035*300,   # 0.006,
    'wp0': -1.0e-08,
    'akvmin': 1.e-4,
    'aktmin': 1.e-5,
    'mxlmin': 1.0,
...
#===========================================================================
fig, axes = plt.subplots(nrows=1, ncols=5, sharex=False,sharey=True, figsize=(14, 4) )
#===========================================================================
ax = axes[0]
...
#==
ax.set_xlabel(r"$^{\circ}{\rm C}\;{\rm m}\;{\rm s}^{-1}$",fontsize=18)
...
if compar_les==1:
  corr_tke_les = -3.22e-05+1.0e-08
  ax.plot(  tke1_les[:]+tke2_les+corr_tke_les,z_r_les*vscale, linewidth=2, color='r'  )
#==
...
#============================================================================
ax = axes[4]
ax.set_title(r"$K_\theta$",fontsize=18)
for i, label in enumerate(run_label):
  ax.plot(scm[i].akt[:],vscale*scm[i].z_w, linestyle=styles[i], color = colors[i],linewidth=linewidth[i])
#==
ax.set_xlabel(r"${\rm m}^2\;{\rm s}^{-1}$",fontsize=18)
ax.ticklabel_format(style='sci', axis='x', scilimits=(0,0))
#===============================
plt.tight_layout()
plt.savefig('FC500_case.pdf', bbox_inches='tight')
#===============================
#plt.show()
