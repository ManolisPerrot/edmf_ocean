...
rerun_scm = True
if rerun_scm:
    subprocess.run(["python", "FC50072h_profile_LES_vs_EDMF.py"])

#== Opening LES and SCM
les,scm = {},{}
for case in cases:
    file = case+'_object_diags_Cw_m1_72h.nc'
    path = '../data/'+case+'/'
...
for case in cases:
    ...
    #
    ax.plot(scm[case]['temp_p'][instant] , scm[case]['z_w']/mld, color[mask], linewidth=linewidth[mask], linestyle=linestyle_scm[case],alpha=alpha[case],label=r'SCM')
...
# labels = [r'No rotation',r'Full rotation']
