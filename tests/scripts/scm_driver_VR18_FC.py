...
###########################################
case        = 'Van_Roekel_2018_FC'
saving_path = '../figures/'
saving_name = case+'72h_profile_VR18_FC.png'
###########################################
end_time   = 72
#===========================================================================
compar_les = 0
if compar_les==1:
  ...
  les_file   = les_dir+"convect_av.nc"
...
#===========================================================================
fig, axes = plt.subplots(nrows=1, ncols=3, sharex=False,sharey=True, figsize=(8, 4) )
#===========================================================================
ax = axes[0]
