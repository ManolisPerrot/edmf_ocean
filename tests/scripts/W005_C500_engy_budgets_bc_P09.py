...
saving_path = '../figures/'
saving_name = case+'_engy_budgets_bc_P09.png'
# ===========================================================================
...
# ax.set_xlabel(r'\rm{time} (hours)')
# ax.set_ylabel(r'${\rm m}^{3}\;{\rm s}^{-3}$')
# ax.plot( (out[0]['Etke'] )[1:]  , linewidth=3 , alpha=1, linestyle = '-', label='Etke')
# ax.plot( (out[0]['Ekin'] )[1:]  , linewidth=3 , alpha=1, linestyle = '-', label='Ekin')
# ax.plot( (out[0]['Epot'] )[1:]  , linewidth=3 , alpha=1, linestyle = '-', label='Epot')
# ax.plot( (out[0]['Etot'] )[1:]  , linewidth=3 , alpha=1, linestyle = '-', label='Etot')

# # ===============================================================

ax.legend()
saving_name=case+'_bc_P09_energy_diag'
