...
saving_path = '../figures/'
saving_name = case+'72h_small_ap_sensitivity.png'
...
run_label = [r'EDMF-Energy', r'EDMF-Energy + non small $a_p$']
runs = [
    {
        'eddy_diff': True,
        'evd': False,
        ...
        'mass_flux_tke_trplCorr': True,
        'mass_flux_small_ap': True,
        'output_filename': case+'_EDMF-energy.nc'
    },
        {
        'eddy_diff': True,
        'evd': False,
        ...
        'output_filename': case+'_nonsmallap.nc'
    },
        ]
...
colors = ['tab:green','tab:green','tab:blue','tab:orange']
alpha = [1,0.5,1,1]
