...
run_label = [r'TKE+EVD',r'EDMF-TKE-inconsistent',  r'EDMF-Energy', r'EDMF-boundary-consistent',r'EDMF-boundary-inconsistent']
runs = [
        {
        'eddy_diff': True,
        'evd': True,
        ...
        'output_filename': case+'_'+run_label[0]+'.nc'
    ...
    },
    {
        ...
        'mass_flux_tke': False,
        'mass_flux_tke_trplCorr': False,
        'output_filename': case+'_'+run_label[1]+'.nc'
    },
        {
        'eddy_diff': True,
        'evd': False,
        ...
        'mass_flux_tke_trplCorr': True,
        'bc_P09': 'false',
        'output_filename': case+'_'+run_label[2]+'.nc'
    },
    {
        'eddy_diff': True,
        'evd': False,
        ...
        'mass_flux_tke_trplCorr': True,
        'bc_P09': 'consistent',
        'output_filename': case+'_'+run_label[3]+'.nc'
    },
    {
        'eddy_diff': True,
        'evd': False,
        ...
        'mass_flux_tke_trplCorr': True,
        'bc_P09': 'inconsistent',
        'output_filename': case+'_'+run_label[4]+'.nc'
    }
        ]
