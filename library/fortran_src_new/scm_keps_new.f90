      ...
      !===================================================================================================
      SUBROUTINE compute_EV_ED_eq (tke,epsil,bvf,N,Akv,Akt,c_mu,c_mu_prim,Lscale)
      !---------------------------------------------------------------------------------------------------
            USE scm_par
            IMPLICIT NONE
            INTEGER, INTENT(IN   )  :: N
  ...
  !          compute the equilibrium value of as
   ...
   !          compute stability function
        ...
        !===================================================================================================
        SUBROUTINE compute_EV_ED_weak (tke,epsil,shear2,bvf,N,Akv,Akt,c_mu,c_mu_prim,Lscale)
        !---------------------------------------------------------------------------------------------------
            USE scm_par
            IMPLICIT NONE
            INTEGER, INTENT(IN   )  :: N
